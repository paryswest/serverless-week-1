...
module.exports = async function (context, req) {
    ...
    let blobname = "blobstoragee"

    var username = req.headers['username'];
    var download = ""
    var downloadpng = "https://" + blobname + ".blob.core.windows.net/blobimages/" + username + ".png";
    var downloadjpg = "https://" + blobname + ".blob.core.windows.net/blobimages/" + username + ".jpeg";
